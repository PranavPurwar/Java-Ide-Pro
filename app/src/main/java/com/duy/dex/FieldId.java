...
public final class FieldId implements Comparable<FieldId> {
    ...
    public int compareTo(FieldId other) {
        if (declaringClassIndex != other.declaringClassIndex) {
            return com.duy.dex.util.Unsigned.compare(declaringClassIndex, other.declaringClassIndex);
        }
        if (nameIndex != other.nameIndex) {
            return com.duy.dex.util.Unsigned.compare(nameIndex, other.nameIndex);
        }
