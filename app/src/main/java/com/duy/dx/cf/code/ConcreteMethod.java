...
public final class ConcreteMethod implements Method {
     ...
     */
    public com.duy.dx.rop.cst.CstString getSourceFile() {
    ...
    public final boolean isDefaultOrStaticInterfaceMethod() {
        return (classFile.getAccessFlags() & com.duy.dx.rop.code.AccessFlags.ACC_INTERFACE) != 0
            && !getNat().isClassInit();
    }
    ...
    /**
     * Returns a {@link com.duy.dx.rop.code.SourcePosition} instance corresponding to the
     * given bytecode offset.
     *
     * @param offset {@code >= 0;} the bytecode offset
     * @return {@code non-null;} an appropriate instance
     */
    public com.duy.dx.rop.code.SourcePosition makeSourcePosistion(int offset) {
