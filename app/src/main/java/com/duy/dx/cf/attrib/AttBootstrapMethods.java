...
public class AttBootstrapMethods extends BaseAttribute {
    ...
    private final com.duy.dx.cf.code.BootstrapMethodsList bootstrapMethods;

    private final int byteLength;

    public AttBootstrapMethods(com.duy.dx.cf.code.BootstrapMethodsList bootstrapMethods) {
