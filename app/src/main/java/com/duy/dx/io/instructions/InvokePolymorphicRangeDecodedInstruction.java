...
public class InvokePolymorphicRangeDecodedInstruction extends com.duy.dx.io.instructions.DecodedInstruction {
    ...
    @Override
    public com.duy.dx.io.instructions.DecodedInstruction withProtoIndex(int newIndex, int newProtoIndex) {
