...
public final class IndexMap {
    ...
    public EncodedValue adjustEncodedValue(EncodedValue encodedValue) {
        com.duy.dx.util.ByteArrayAnnotatedOutput out = new com.duy.dx.util.ByteArrayAnnotatedOutput(32);
    ...
    public Annotation adjust(Annotation annotation) {
        com.duy.dx.util.ByteArrayAnnotatedOutput out = new ByteArrayAnnotatedOutput(32);
