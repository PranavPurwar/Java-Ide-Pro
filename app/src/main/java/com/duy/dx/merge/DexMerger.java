...
public final class DexMerger {
    ...
    private final com.duy.dx.command.dexer.DxContext context;
    ...
    public DexMerger(Dex[] dexes, CollisionPolicy collisionPolicy, com.duy.dx.command.dexer.DxContext context)
            throws IOException {
        this(dexes, collisionPolicy, context, new WriterSizes(dexes));
    }

    private DexMerger(Dex[] dexes, CollisionPolicy collisionPolicy, com.duy.dx.command.dexer.DxContext context,
