...
public class Main {
    ...
    private com.duy.dx.dex.file.ClassDefItem translateClass(byte[] bytes, DirectClassFile cf) {
        try {
    ...
    private boolean addClassToDex(com.duy.dx.dex.file.ClassDefItem clazz) {
    ...
    private void dumpMethod(DexFile dex, String fqName,
        ...
        com.duy.dx.dex.file.ClassDefItem clazz = dex.getClassOrNull(className);
        ...
        TreeMap<com.duy.dx.rop.cst.CstNat, EncodedMethod> meths =
        ...
        for (EncodedMethod meth : meths.values()) {
            ...
            com.duy.dx.rop.annotation.Annotations methodAnnotations =
            ...
            if (methodAnnotations != null) {
                ...
                for (com.duy.dx.rop.annotation.Annotation a : methodAnnotations.getAnnotations()) {
                    pw.println("    " + a);
                }
            }
    ...
    private class DirectClassFileConsumer implements Callable<Boolean> {
        ...
        private Boolean call(DirectClassFile cf) {
            ...
            Future<com.duy.dx.dex.file.ClassDefItem> cdif = classTranslatorPool.submit(
    ...
    private class ClassTranslatorTask implements Callable<com.duy.dx.dex.file.ClassDefItem> {
        ...
        @Override
        public com.duy.dx.dex.file.ClassDefItem call() {
            com.duy.dx.dex.file.ClassDefItem clazz = translateClass(bytes, classFile);
            return clazz;
        }
    }
    ...
    private class ClassDefItemConsumer implements Callable<Boolean> {
        ...
        String name;
        Future<com.duy.dx.dex.file.ClassDefItem> futureClazz;
        int maxMethodIdsInClass;
        int maxFieldIdsInClass;

        private ClassDefItemConsumer(String name, Future<com.duy.dx.dex.file.ClassDefItem> futureClazz,
