...
public final class CstInvokeDynamic extends Constant {
    ...
    private com.duy.dx.rop.cst.CstType declaringClass;

    /** {@code null-ok;} the associated call site */
    private com.duy.dx.rop.cst.CstCallSite callSite;

    /** {@code non-null;} list of references to this {@code CstInvokeDynamic} constant */
    private final List<com.duy.dx.rop.cst.CstCallSiteRef> references;
     ...
     */
    public com.duy.dx.rop.cst.CstCallSiteRef addReference() {
        com.duy.dx.rop.cst.CstCallSiteRef ref = new com.duy.dx.rop.cst.CstCallSiteRef(this, references.size());
        references.add(ref);
        return ref;
    }
     ...
     */
    public void setDeclaringClass(com.duy.dx.rop.cst.CstType declaringClass) {
     ...
     */
    public void setCallSite(com.duy.dx.rop.cst.CstCallSite callSite) {
