 ...
 * multiple constants.
 */
public class InvokePolymorphicInsn extends com.duy.dx.rop.code.Insn {
    /** Default descriptor for signature polymorphic methods. */
    private static final com.duy.dx.rop.cst.CstString DEFAULT_DESCRIPTOR =
            new com.duy.dx.rop.cst.CstString("([Ljava/lang/Object;)Ljava/lang/Object;");

    /** Descriptor for VarHandle set methods. */
    private static final com.duy.dx.rop.cst.CstString VARHANDLE_SET_DESCRIPTOR =
            new com.duy.dx.rop.cst.CstString("([Ljava/lang/Object;)V");

    /** Descriptor for VarHandle compare-and-set methods. */
    private static final com.duy.dx.rop.cst.CstString VARHANDLE_COMPARE_AND_SET_DESCRIPTOR =
            new com.duy.dx.rop.cst.CstString("([Ljava/lang/Object;)Z");
     ...
     */
    private final com.duy.dx.rop.cst.CstMethodRef callSiteMethod;

    /**
     * {@code non-null;} signature polymorphic method.
     */
    private final com.duy.dx.rop.cst.CstMethodRef polymorphicMethod;

    /**
     * {@code non-null;} the call site prototype.
     */
    private final com.duy.dx.rop.cst.CstProtoRef callSiteProto;
     ...
     */
    public InvokePolymorphicInsn(com.duy.dx.rop.code.Rop opcode, SourcePosition position, com.duy.dx.rop.code.RegisterSpecList sources, TypeList catches,
                                 com.duy.dx.rop.cst.CstMethodRef callSiteMethod) {
     ...
     */
    public com.duy.dx.rop.cst.CstMethodRef getCallSiteMethod() {
     ...
     */
    public com.duy.dx.rop.cst.CstMethodRef getPolymorphicMethod() {
     ...
     */
    public com.duy.dx.rop.cst.CstProtoRef getCallSiteProto() {
    ...
    private static com.duy.dx.rop.cst.CstMethodRef makePolymorphicMethod(final com.duy.dx.rop.cst.CstMethodRef callSiteMethod) {
        com.duy.dx.rop.cst.CstType definingClass= callSiteMethod.getDefiningClass();
        CstString cstMethodName = callSiteMethod.getNat().getName();
        String methodName = callSiteMethod.getNat().getName().getString();

        if (definingClass.equals(com.duy.dx.rop.cst.CstType.METHOD_HANDLE)) {
            if (methodName.equals("invoke") || methodName.equals("invokeExact")) {
                com.duy.dx.rop.cst.CstNat cstNat = new com.duy.dx.rop.cst.CstNat(cstMethodName, DEFAULT_DESCRIPTOR);
                return new com.duy.dx.rop.cst.CstMethodRef(definingClass, cstNat);
            }
        }
        ...
        if (definingClass.equals(CstType.VAR_HANDLE)) {
            switch (methodName) {
                ...
                case "setVolatile":
                {
                    com.duy.dx.rop.cst.CstNat cstNat = new com.duy.dx.rop.cst.CstNat(cstMethodName, VARHANDLE_SET_DESCRIPTOR);
                    return new com.duy.dx.rop.cst.CstMethodRef(definingClass, cstNat);
                }
                case "compareAndSet":
                ...
                {
                    com.duy.dx.rop.cst.CstNat cstNat = new CstNat(cstMethodName, VARHANDLE_COMPARE_AND_SET_DESCRIPTOR);
                    return new com.duy.dx.rop.cst.CstMethodRef(definingClass, cstNat);
                }
                default:
                    break;
    ...
    private static com.duy.dx.rop.cst.CstProtoRef makeCallSiteProto(final CstMethodRef callSiteMethod) {
