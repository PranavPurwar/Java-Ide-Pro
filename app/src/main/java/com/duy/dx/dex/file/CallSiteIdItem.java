...
public final class CallSiteIdItem extends IndexedItem implements Comparable {
    ...
    final com.duy.dx.rop.cst.CstCallSiteRef invokeDynamicRef;

    com.duy.dx.dex.file.CallSiteItem data;
    ...
    public void addContents(DexFile file) {
        ...
        com.duy.dx.dex.file.CallSiteItem callSiteItem = callSiteIds.getCallSiteItem(callSite);
