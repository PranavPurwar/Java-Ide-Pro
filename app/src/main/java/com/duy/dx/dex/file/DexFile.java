...
public final class DexFile {
     ...
     * straightforward way. See {@link com.duy.dx.dex.file.MapItem#addMap} for more detail.
     */
    ...
    private final com.duy.dx.dex.file.StringIdsSection stringIds;

    /** {@code non-null;} type identifiers section */
    private final com.duy.dx.dex.file.TypeIdsSection typeIds;

    /** {@code non-null;} prototype identifiers section */
    private final com.duy.dx.dex.file.ProtoIdsSection protoIds;

    /** {@code non-null;} field identifiers section */
    private final com.duy.dx.dex.file.FieldIdsSection fieldIds;

    /** {@code non-null;} method identifiers section */
    private final MethodIdsSection methodIds;

    /** {@code non-null;} class definitions section */
    private final com.duy.dx.dex.file.ClassDefsSection classDefs;
    ...
    private final com.duy.dx.dex.file.CallSiteIdsSection callSiteIds;

    /** {@code null-ok;} method handles section, only exists for SDK >= 26 */
    private final com.duy.dx.dex.file.MethodHandlesSection methodHandles;
     ...
     */
    public DexFile(final com.duy.dx.dex.DexOptions dexOptions) {
        ...
        stringIds = new com.duy.dx.dex.file.StringIdsSection(this);
        typeIds = new com.duy.dx.dex.file.TypeIdsSection(this);
        protoIds = new com.duy.dx.dex.file.ProtoIdsSection(this);
        fieldIds = new com.duy.dx.dex.file.FieldIdsSection(this);
        methodIds = new MethodIdsSection(this);
        classDefs = new com.duy.dx.dex.file.ClassDefsSection(this);
        ...
        if (dexOptions.apiIsSupported(DexFormat.API_METHOD_HANDLES)) {
             ...
             */
            callSiteIds = new com.duy.dx.dex.file.CallSiteIdsSection(this);
            methodHandles = new com.duy.dx.dex.file.MethodHandlesSection(this);
    ...
    public ClassDefItem getClassOrNull(String name) {
        try {
            com.duy.dx.rop.type.Type type = Type.internClassName(name);
            return (ClassDefItem) classDefs.get(new com.duy.dx.rop.cst.CstType(type));
    ...
    public void writeTo(OutputStream out, Storage storage, Writer humanOut, boolean verbose)
        ...
        com.duy.dx.util.ByteArrayAnnotatedOutput result = toDex0(annotate, verbose, storage);
     ...
     */
    public com.duy.dx.util.ByteArrayAnnotatedOutput writeTo(Storage storage) {
    ...
    public byte[] toDex(Writer humanOut, boolean verbose)
        throws IOException {
        boolean annotate = (humanOut != null);
        com.duy.dx.util.ByteArrayAnnotatedOutput result = toDex0(annotate, verbose, null);
     ...
     */
    /*package*/ void internIfAppropriate(com.duy.dx.rop.cst.Constant cst) {
        if (cst == null) {
            throw new NullPointerException("cst == null");
        }

        if (cst instanceof com.duy.dx.rop.cst.CstString) {
            stringIds.intern((com.duy.dx.rop.cst.CstString) cst);
        } else if (cst instanceof com.duy.dx.rop.cst.CstType) {
            typeIds.intern((com.duy.dx.rop.cst.CstType) cst);
        } else if (cst instanceof com.duy.dx.rop.cst.CstBaseMethodRef) {
            methodIds.intern((com.duy.dx.rop.cst.CstBaseMethodRef) cst);
        } else if (cst instanceof com.duy.dx.rop.cst.CstFieldRef) {
            fieldIds.intern((com.duy.dx.rop.cst.CstFieldRef) cst);
        } else if (cst instanceof com.duy.dx.rop.cst.CstEnumRef) {
            fieldIds.intern(((com.duy.dx.rop.cst.CstEnumRef) cst).getFieldRef());
        } else if (cst instanceof com.duy.dx.rop.cst.CstProtoRef) {
            protoIds.intern(((com.duy.dx.rop.cst.CstProtoRef) cst).getPrototype());
        } else if (cst instanceof com.duy.dx.rop.cst.CstMethodHandle) {
            methodHandles.intern((com.duy.dx.rop.cst.CstMethodHandle) cst);
        }
    }

    /**
     * Gets the {@link com.duy.dx.dex.file.IndexedItem} corresponding to the given constant,
    ...
    /**
     * Returns the contents of this instance as a {@code .dex} file,
     * in a {@link com.duy.dx.util.ByteArrayAnnotatedOutput} instance.
     *
     * @param annotate whether or not to keep annotations
     * @param verbose if annotating, whether to be verbose
     * @return {@code non-null;} a {@code .dex} file for this instance
     */
    private com.duy.dx.util.ByteArrayAnnotatedOutput toDex0(boolean annotate,
                                                                     boolean verbose,
                                                                     Storage storage) {
        /*
        ...
        com.duy.dx.util.ByteArrayAnnotatedOutput out = new ByteArrayAnnotatedOutput(barr);
     ...
     */
    public com.duy.dx.dex.file.Statistics getStatistics() {
        com.duy.dx.dex.file.Statistics stats = new Statistics();
