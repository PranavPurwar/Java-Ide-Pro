...
public final class CallSiteIdsSection extends UniformItemSection {
    ...
    private final TreeMap<com.duy.dx.rop.cst.CstCallSiteRef, CallSiteIdItem> callSiteIds = new TreeMap<>();

    /** A map from call site instances to their DEX file item. */
    private final TreeMap<com.duy.dx.rop.cst.CstCallSite, CallSiteItem> callSites = new TreeMap<>();
    ...
    public IndexedItem get(Constant cst) {
        ...
        IndexedItem result = callSiteIds.get((com.duy.dx.rop.cst.CstCallSiteRef) cst);
        if (result == null) {
     ...
     */
    void addCallSiteItem(com.duy.dx.rop.cst.CstCallSite callSite, CallSiteItem callSiteItem) {
        if (callSite == null) {
