...
public final class MethodHandlesSection extends UniformItemSection {
    ...
    private final TreeMap<com.duy.dx.rop.cst.CstMethodHandle, MethodHandleItem> methodHandles = new TreeMap<>();
    ...
    public IndexedItem get(Constant cst) {
        ...
        IndexedItem result = methodHandles.get((com.duy.dx.rop.cst.CstMethodHandle) cst);
        if (result == null) {
    ...
    public synchronized void intern(com.duy.dx.rop.cst.CstMethodHandle methodHandle) {
