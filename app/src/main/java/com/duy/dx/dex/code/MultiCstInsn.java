...
public final class MultiCstInsn extends FixedSizeInsn {
    ...
    private final com.duy.dx.rop.cst.Constant[] constants;
     ...
     */
    public MultiCstInsn(com.duy.dx.dex.code.Dop opcode, com.duy.dx.rop.code.SourcePosition position,
                        com.duy.dx.rop.code.RegisterSpecList registers, com.duy.dx.rop.cst.Constant[] constants) {
    ...
    private MultiCstInsn(com.duy.dx.dex.code.Dop opcode, SourcePosition position,
                         com.duy.dx.rop.code.RegisterSpecList registers, com.duy.dx.rop.cst.Constant[] constants, int[] index,
                         int classIndex) {
        super(opcode, position, registers);
        this.constants = constants;
        this.index = index;
    ...
    public String cstComment() {
        ...
        for (int i = 0; i < constants.length; ++i) {
            ...
            if (currentIndex < 65536) {
                sb.append(com.duy.dx.util.Hex.u2(currentIndex));
            } else {
