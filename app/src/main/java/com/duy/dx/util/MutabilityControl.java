...
public class MutabilityControl {
    ...
    /**
     * Throws {@link com.duy.dx.util.MutabilityException} if this instance is
     * immutable.
     */
    public final void throwIfImmutable() {
        if (!mutable) {
            throw new com.duy.dx.util.MutabilityException("immutable instance");
        }
    }

    /**
     * Throws {@link com.duy.dx.util.MutabilityException} if this instance is mutable.
     */
